  ...
  <div>
    <div class="mb-3">
      ...
      <b-progress class="w-50 mx-auto">
        <b-progress-bar
          :value="scaleZ(individual_abs_mot_z)"
    ...
    <div class="mb-3">
      ...
      <b-progress class="w-50 mx-auto">
        <b-progress-bar
          :value="scaleZ(individual_rel_mot_z)"
...
export default {
  ...
  computed: {
    ...
    individual_abs_mot_z() {
      if (this.individual) {
        return (
          (this.individual.qc_mot_abs - this.mean_group_abs_mot) /
          this.std_group_abs_mot
        );
      }
      return null;
    },
    ...
    individual_rel_mot_z() {
      if (this.individual) {
        return (
          (this.individual.qc_mot_rel - this.mean_group_rel_mot) /
          this.std_group_rel_mot
        );
      }
      return null;
    },
